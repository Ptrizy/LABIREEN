...
import 'package:labireen/widget/home_page/card_receipt_page.dart';
import 'package:labireen/widget/home_page/makanan.dart';
import 'package:labireen/widget/home_page/notes.dart';

class ReceiptPage extends StatefulWidget {
  const ReceiptPage({Key? key, required this.makanan}) : super(key: key);
          ...
          Expanded(
            child: Container(
              child: ListView.builder(
                itemCount: keranjangMakanan.length,
                itemBuilder: (context, index) {
                  return CardReceiptPage(makanan: keranjangMakanan[index]);
                },
              ),
            ),
          ),
            ...
            child: Center(
              child: ElevatedButton(
                  ...
                  style: ButtonStyle(
                    ...
                    minimumSize: MaterialStateProperty.all<Size>(Size(108, 29)),
                  ),
                  child: Text(
                    'Tambah pesanan',
                    style: GoogleFonts.poppins(
